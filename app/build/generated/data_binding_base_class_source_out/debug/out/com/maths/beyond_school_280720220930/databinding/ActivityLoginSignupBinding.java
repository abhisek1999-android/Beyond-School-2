...
public final class ActivityLoginSignupBinding implements ViewBinding {
  ...
  private ActivityLoginSignupBinding(@NonNull RelativeLayout rootView, @NonNull TextView header) {
  ...
  public static ActivityLoginSignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginSignupBinding((RelativeLayout) rootView, header);
    }
