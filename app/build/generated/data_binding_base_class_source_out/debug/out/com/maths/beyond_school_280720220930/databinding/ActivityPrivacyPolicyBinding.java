...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
  ...
  @NonNull
  public final WebView privacyPolicyView;

  @NonNull
  public final ToolBarLayoutBackButtonBinding toolBar;

  private ActivityPrivacyPolicyBinding(@NonNull LinearLayout rootView,
      @NonNull WebView privacyPolicyView, @NonNull ToolBarLayoutBackButtonBinding toolBar) {
  ...
  public static ActivityPrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.privacyPolicyView;
      WebView privacyPolicyView = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityPrivacyPolicyBinding((LinearLayout) rootView, privacyPolicyView,
          binding_toolBar);
    }
