  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `ProgressM` (`date` TEXT, `table` TEXT, `time_to_complete` TEXT, `correct` TEXT, `time` TEXT, `wrong` TEXT, `is_complete` TEXT, `progress_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'f4efc67021449660ca5f08e2bbde138e')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsProgressM = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsProgressM.put("correct", new TableInfo.Column("correct", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProgressM.put("time", new TableInfo.Column("time", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProgressM.put("wrong", new TableInfo.Column("wrong", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoProgressM.equals(_existingProgressM)) {
          return new RoomOpenHelper.ValidationResult(false, "ProgressM(com.maths.beyond_school_280720220930.database.ProgressM).\n"
                  + " Expected:\n" + _infoProgressM + "\n"
                  + " Found:\n" + _existingProgressM);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "f4efc67021449660ca5f08e2bbde138e", "dda72c1a4fcc22466d59d986ce43820d");
